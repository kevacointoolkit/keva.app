...
$eth=trim(strip_tags($_REQ["eth"]));
$rvn=trim(strip_tags($_REQ["rvn"]));
$kva=trim(strip_tags($_REQ["kva"]));
...
if(strlen($eth)==42){
		...
		$ethnft=$kpc->keva_put($goodname,"ETHEREUM",$eth);

		$ethnft=$kpc->keva_put($goodname,"OPENSEA","50");
...
if(strlen($rvn)==34){
		...
		$rvnnft=$kpc->keva_put($goodname,"RAVENCOIN",$rvn);

		$rvnnft=$kpc->keva_put($goodname,"ASSET","on");
...
$thenft=$kpc->keva_put($goodname,"THEME","nft");
...
if(!$sn){$bigstep="Please Get again";}else{

$bigstep="Your NFTs code is <font color=\"8CEA00\">".$sn."</font> You can open <a href=https://keva.app?".$sn."><font color=\"8CEA00\">keva.app?".$sn."</font></a> to see your NFTs and share to everyone.(It will take 0-30min to write on the blockchain.)";}
...
if(strlen($kva)==34){
		...
		$agex=$kpc->keva_put($goodname,"Congratulations",$bigstep,$kva); 
			...
			echo "<br><form action=\"\" method=\"post\" >";	
					...
					echo "<center><input type=\"text\" name=\"eth\" id=\"editor\" class=\"textarea-inherit\"  style=\"width:300px;border: 1px solid #59fbea;font-family: coda_regular, arial, helvetica, sans-serif;-webkit-appearance: none;-webkit-border-radius:0;height:36px;font-size: 30px; background-color: rgb(11, 12, 13);color: #ddd;padding-left:10px;
\" value=\"\" maxlength=42 placeholder=\"ETH ADDRESS\"><br><br>";

			echo "<input type=\"text\" name=\"rvn\" id=\"editor\" class=\"textarea-inherit\"  style=\"width:300px;border: 1px solid #59fbea;font-family: coda_regular, arial, helvetica, sans-serif;-webkit-appearance: none;-webkit-border-radius:0;height:36px;font-size: 30px; background-color: rgb(11, 12, 13);color: #ddd;padding-left:10px;
\" value=\"\" maxlength=34 placeholder=\"RVN ADDRESS\"><br><br>";

			echo "<input type=\"text\" name=\"kva\" id=\"editor\" class=\"textarea-inherit\"  style=\"width:300px;border: 1px solid #59fbea;font-family: coda_regular, arial, helvetica, sans-serif;-webkit-appearance: none;-webkit-border-radius:0;height:36px;font-size: 30px; background-color: rgb(11, 12, 13);color: #ddd;padding-left:10px;
\" value=\"\" maxlength=34 placeholder=\"KVA ADDRESS\"></center><br>";
...
echo "<center><input type=\"submit\" value=\"GET NFTs CODE\" style=\"border: 1px solid #59fbea;-webkit-appearance:none ;-webkit-border-radius: 0;border-radius:0;height:36px;background-color: rgb(0, 79, 74);color: #59fbea;margin-left:20px;width:180px;font-size: 20px;padding-top:0px;\"></center></li></ul></div>";
...
echo "This is free NFTs shortcode for everyone. You will get a code like <a href=https://keva.app?63968971>63968971</a> and you can input the code on keva.app or open <a href=https://keva.app?63968971>keva.app?63968971</a> to see all your NFTs.<br><br>";

echo "All the datas are on the <a href=https://kevacoin.org/><font color=\"8CEA00\">kevacoin</font></a> blockchain. The code is read-only. If you have <a href=https://kevacoin.org/><font color=\"8CEA00\">kevacoin  wallet</font></a>, you can input your kva address to get the code and manage your web3 space, change your opensea nft number.(now is 50)<br><br>";

echo "You can also just input your kva address to get a code too.<br>";
