...
function PhotoPile(options){
    ...
    var config, defaultOptions = {
        // Thumbnails
        numLayers:          '',          // number of layers in the pile (max zindex)
        thumbOverlap:       '',         // overlap amount (px)
        thumbRotation:      '',         // maximum rotation (deg)
        thumbBorderWidth:   0,          // border width (px)
        thumbBorderColor:   '',    // border color
        thumbBorderHover:   '',  // border hover color
